"""
Management command to add City Mid-Range (₱25,000 - ₱75,000) products for bike builder.
...
class Command(BaseCommand):
    help = 'Add City Mid-Range products for bike builder (₱25,000 - ₱75,000)'

    def handle(self, *args, **kwargs):
        self.stdout.write('Adding City Mid-Range products for bike builder...\n')
        ...
        tag_values = {
            'use_case': ['city'],
            'budget': ['mid'],
            'physical': ['wheel_700c', 'disc_brake', 'material_carbon', 'material_aluminum', 'handlebar_flat', 'saddle_sport'],
        }
        ...
        # Product definitions for City Mid-Range build
        products_data = [
            {
                ...
                'priority': 8,
                'tags': [tags.get('city'), tags.get('mid'), tags.get('material_carbon'), tags.get('wheel_700c'), tags.get('disc_brake')],
                'variants': [
            ...
            },
            {
                ...
                'priority': 8,
                'tags': [tags.get('city'), tags.get('mid'), tags.get('wheel_700c'), tags.get('disc_brake')],
            ...
            },
            {
                ...
                'priority': 8,
                'tags': [tags.get('city'), tags.get('mid')],
            ...
            },
            {
                ...
                'priority': 8,
                'tags': [tags.get('city'), tags.get('mid'), tags.get('disc_brake'), tags.get('hydraulic_disc')],
                'variants': [('Standard', 3, Decimal('12499.00'))],
            },
            {
                'name': 'Urban Performance Bars',
                'description': 'Ergonomic handlebars optimized for city commuting.',
                'category': 'handlebars',
                'brand': brands['Trek'],
                'price': Decimal('3499.00'),
                'priority': 8,
                'tags': [tags.get('city'), tags.get('mid'), tags.get('handlebar_flat')],
                'variants': [('Standard', 5, Decimal('3499.00'))],
            },
            {
                'name': 'City Sport Saddle',
                'description': 'Performance-oriented saddle with comfort features for longer commutes.',
                'category': 'saddle',
                'brand': brands['Specialized'],
                'price': Decimal('4999.00'),
                'priority': 8,
                'tags': [tags.get('city'), tags.get('mid'), tags.get('saddle_sport')],
                'variants': [('Black', 4, Decimal('4999.00'))],
            },
        ]
            ...
            if created:
                ...
                for variant_name, stock, price in product_data['variants']:
                    Product.objects.create(
                        ...
                        sku=f"{product_data['category'].upper()}-CITY-MID-{variant_name.replace(' ', '-').upper()}",
                        price=price,
                        stock=stock,
                        available=True,
                    )
        ...
        self.stdout.write('\nCity Mid-Range products added successfully!')
